...
export const ADD_YES_ASSET_RESPONSE = "ADD_YES_ASSET_RESPONSE";
export const ADD_NO_ASSET_RESPONSE = "ADD_NO_ASSET_RESPONSE";
export const ADD_WINNER_RESPONSE = "ADD_WINNER_RESPONSE";
